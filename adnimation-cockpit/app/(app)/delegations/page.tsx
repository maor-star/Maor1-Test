...
export default async function DelegationsPage({
  ...
  return (
    <div className="space-y-5">
      ...
      {!sharedThreads ? (
        <div className="border border-line px-4 py-2 font-semi text-[11px] tracking-[0.06em] text-neutral-500">
          ...
          Slack too, add the <span className="text-info">mpim:write</span> and{' '}
          <span className="text-info">mpim:history</span> scopes to the Slack app and

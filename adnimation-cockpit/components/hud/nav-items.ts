...
export const NAV = [
  ...
  { href: '/clients', label: 'CLIENTS', num: '08', ready: true },
  { href: '/crm', label: 'CRM', num: '09', ready: true },
  { href: '/seats/demand', label: 'DEMAND', num: '10', ready: true },
  { href: '/seats/supply', label: 'SUPPLY', num: '11', ready: true },
  { href: '/trading', label: 'TRADING', num: '12', ready: true },
  { href: '/pipeline', label: 'PIPELINE', num: '13', ready: true },

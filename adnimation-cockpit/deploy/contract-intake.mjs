/**
 * GENERATED FROM lib/contracts/intake.ts — do not edit by hand.
 *
 * The jobs run as plain ESM outside the compiled app, so they need a
 * JavaScript copy of these rules. tests/unit/contract-parity.test.ts
...
export function looksLikeContract(input) {
  const reasons = [];
 ...
 */
export function versionFromName(fileName, existingVersions) {
  const explicit =

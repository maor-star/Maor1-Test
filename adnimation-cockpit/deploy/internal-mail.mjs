/**
 * GENERATED FROM lib/agents/internal-mail.ts — do not edit by hand.
 *
 * The jobs run as plain ESM outside the compiled app, so they need a
 * JavaScript copy of these rules. tests/unit/internal-mail-parity.test.ts
...
export function isInternalAddress(address, domains = INTERNAL_DOMAINS) {
...
export function assertInternalRecipients(recipients, domains = INTERNAL_DOMAINS) {
...
export function looksLikeInvoice(input) {

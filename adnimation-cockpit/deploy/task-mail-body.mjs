/**
 * GENERATED FROM lib/tasks/mail-body.ts — do not edit by hand.
 *
 * The jobs run as plain ESM outside the compiled app, so they need a
 * JavaScript copy of these rules. tests/unit/task-mail-body-parity.test.ts
...
const isQuoteStart = (line) => QUOTE_MARKERS.some((r) => r.test(line.trim()));
 ...
 * kept instead.
 */
export function withoutQuotes(raw) {
